...
if (!cX.library) {
    cX.library = {
        ...
        isRecsDestination: function(locationHref, documentReferrer) {
            ...
            return !!(locationHref.indexOf('cxrecs_s') > -1 || documentReferrer.match(/cdn\.cxpublic\.com\/generic_v[0-9]+\.html/));
        },
        ...
        sendPageViewEvent: function(args) {
            var allArgs = args || {};
                ...
                if (document.images) {
                    ...
                    try {
                        if (this.hasLocalStorage()) {
                            ...
                            if (Number.isNaN(lastP1Time) || lastP1Time < now - 1000 * 60 * 60 * 24 * 5 || lastP1Time > now) {
                                useP1 = true;
            ...
            try {
                if (typeof message === 'object' && typeof message.data === 'string') {
                    ...
                    if (typeof object.elementId !== 'undefined' && object.method === 'updateAdSpace') {
                        ...
                        this._handleParentMetricsRequest(object);
        ...
        _handleParentMetricsRequest: function(request) {
        ...
        insertWidget: function(args, requestObject) {
            ...
            if (args.renderTemplateUrl === 'auto') {
                args.renderTemplateUrl = 'http://cdn.cxpublic.com/generic_v1.html';
            }
        ...
        _insertWidget: function(args, requestObject) {
            ...
            if (isRenderTemplateRequest || args.isSlave) {
                params = '#';
                if (!this._isEmptyObject(requestObject)) {
            ...
            for (var argName in allArgs) {
                ...
                if (typeof allArgs[argName] !== 'function' &&
                    ...
                    (isRenderTemplateRequest || (argName !== 'backend' && argName !== 'secureBaseAdDeliveryUrl' && argName !== 'baseAdDeliveryUrl'))) {
            ...
            if (media === 'html' && adSpaceId && allArgs.adUnitWidth && allArgs.adUnitHeight) {
            ...
            if (args.adSpaceIds) {
                ...
                if (allArgs.webkitIframeCacheBugWorkaround) {
